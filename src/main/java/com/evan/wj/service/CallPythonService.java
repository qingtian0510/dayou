...
public class CallPythonService {
    ...
    public Map<String, String> getByNameAndCount(String username, int count) throws IOException {

        Map<String, String> res = new HashMap<>();
        //TODO "55407457717" 抓取请求uid替换
        String[] arg = new String[]{pythonPath, pythonScriptPath, username, "55380477764", Integer.toString(count)};
